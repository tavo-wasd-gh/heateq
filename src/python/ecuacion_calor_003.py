...
Lx = # largo del dominio en x (Lx) en metros
Ly = # largo del dominio en y (Ly) en metros
Nx = # Número de puntos de la malla en x
Ny =  # Número de puntos de la malla en y
...
condiciones_frontera = 'punto_caliente'  # Opciones: 'punto_caliente', 'gradiente_lineal', 'onda




### ya para generarlo
ecuacion = ecuacion_calor("variables a utilizar aca")
